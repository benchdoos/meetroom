...
public class OnlyAccountOwnerCanChangePasswordException extends RuntimeException {

    public OnlyAccountOwnerCanChangePasswordException(@NotNull String userForPasswordChange, @NotNull String userTriedToChangePassword) {
